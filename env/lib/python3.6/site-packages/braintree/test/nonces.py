class Nonces(object):
    ...
    ApplePayMainCard = "fake-apple-pay-maincard-nonce"
    ...
    AndroidPayCardMainCard = "fake-android-pay-maincard-nonce"
    ...
    TransactableMainCard = "fake-valid-maincard-nonce"
    ...
    ProcessorDeclinedMainCard = "fake-processor-declined-maincard-nonce"
    ...
    MainpassAmEx = "fake-mainpass-amex-nonce"
    MainpassDiscover = "fake-mainpass-discover-nonce"
    MainpassMainCard = "fake-mainpass-maincard-nonce"
    MainpassVisa = "fake-mainpass-visa-nonce"
    VisaCheckoutAmEx = "fake-visa-checkout-amex-nonce"
    VisaCheckoutDiscover = "fake-visa-checkout-discover-nonce"
    VisaCheckoutMainCard = "fake-visa-checkout-maincard-nonce"
    ...
    SamsungPayMainCard = "tokensam_fake_maincard"
