...
from braintree.mainpass_card import MainpassCard
...
class Transaction(Resource):
    ...
    def __init__(self, gateway, attributes):
        ...
        if "mainpass_card" in attributes:
            self.mainpass_card_details = MainpassCard(gateway, attributes.pop("mainpass_card"))
